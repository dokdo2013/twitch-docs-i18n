...
For this exercise, open a terminal window and enter the following cURL POST command (you’ll need cURL installed on your computer). Update the client ID and secret placeholders with the client ID and secret you recieved when you registered your app.
